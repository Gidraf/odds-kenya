...
@flask_app.cli.command("seed-accounts")
...
@flask_app.cli.command("get-token")
...
@flask_app.cli.command("list-accounts")
def list_accounts():
...
@flask_app.cli.command("delete-account")
@click.argument("email")
...
@flask_app.cli.command("test-login")
@click.argument("email")
...
@flask_app.cli.command("list-bookmakers")
def list_bookmakers():
...
@flask_app.cli.command("market-failures")
...
@flask_app.cli.command("harvest-health")
@click.option("--bk",    default=None, help="Filter by bookmaker slug")
@click.option("--sport", default=None, help="Filter by sport slug")
