...
def normalize_outcome(market_slug: str, raw_key: str, display: str = "") -> str:
    ...
    # Player names: "firstname_lastname" → "Firstname Lastname"
    # OD sends player names as underscore_joined_lowercase strings
    if re.match(r"^[a-z][a-z_\-]{2,}$", kl) and "_" in key:
        # Don't transform known non-player keys
        known_non_player = {
            "no_goal", "no_goalscorer", "none", "own_goal",
            "home_win", "away_win", "home_or_draw", "draw_or_away",
            "home_or_away", "first_half", "second_half", "full_time",
        }
        if kl not in known_non_player:
            # Titlecase each part: "azpilicueta_cesar" → "Azpilicueta Cesar"
            parts = key.replace("-", " ").split("_")
            # Only format as player name if all parts look like name fragments (alphabetic)
...
_KNOWN_IDS: dict[int, dict[str, str]] = {
    ...
    6:   {"soccer": "draw_no_bet"},               # 2-way, no draw
    7:   {"soccer": "correct_score"},
    8:   {"soccer": "half_time_result"},
    9:   {"soccer": "half_time_result"},
    10:  {"soccer": "over_under_goals"},
    11:  {"soccer": "asian_handicap"},
    12:  {"soccer": "european_handicap"},
    13:  {"soccer": "odd_even_goals"},
    14:  {"soccer": "first_half_over_under"},
    15:  {"soccer": "first_half_1x2"},
    16:  {"soccer": "draw_no_bet"},               # 2-way (1 or 2, no draw) — seen in screenshot
    17:  {"soccer": "btts"},
    18:  {"soccer": "first_half_btts"},
    19:  {"soccer": "first_half_double_chance"},
    20:  {"soccer": "half_time_full_time"},
    21:  {"soccer": "winning_margin"},
    22:  {"soccer": "half_time_full_time"},
    23:  {"soccer": "btts_first_half"},
    24:  {"soccer": "asian_handicap"},
    25:  {"soccer": "over_under_goals_0_5"},
    26:  {"soccer": "over_under_goals_1_5"},
    27:  {"soccer": "over_under_goals_3_5"},
    28:  {"soccer": "over_under_goals_4_5"},
    29:  {"soccer": "over_under_goals_0_5"},
    30:  {"soccer": "result_and_btts"},
    31:  {"soccer": "result_and_over_under"},
    32:  {"soccer": "double_chance_and_btts"},
    33:  {"soccer": "exact_goals"},
    34:  {"soccer": "total_goals_exact"},
    35:  {"soccer": "first_half_over_under"},
    36:  {"soccer": "first_half_asian_handicap"},
    37:  {"soccer": "first_goalscorer"},
    38:  {"soccer": "anytime_goalscorer"},         # player name outcomes — seen in screenshot
    39:  {"soccer": "last_goalscorer"},
    40:  {"soccer": "first_half_correct_score"},
    41:  {"soccer": "asian_handicap"},
    42:  {"soccer": "double_chance"},
    43:  {"soccer": "draw_no_bet"},
    44:  {"soccer": "over_under_goals_2_5"},
    45:  {"soccer": "over_under_goals_5_5"},
    46:  {"soccer": "over_under_goals_6_5"},
    47:  {"soccer": "btts_and_over_under"},
    48:  {"soccer": "result_and_over_under_1_5"},
    49:  {"soccer": "result_and_over_under_2_5"},
    50:  {"soccer": "result_and_over_under_3_5"},
    51:  {"soccer": "multigoals"},
    52:  {"soccer": "team_total_goals_home"},
    53:  {"soccer": "team_total_goals_away"},
    54:  {"soccer": "first_half_1x2"},
    55:  {"soccer": "second_half_1x2"},
    56:  {"soccer": "odd_even_goals"},
    57:  {"soccer": "correct_score"},
    58:  {"soccer": "asian_handicap"},
    59:  {"soccer": "winning_margin"},
    60:  {"soccer": "double_chance_and_over_under"},
    # ── Soccer extended ────────────────────────────────────────────────────────
    93:  {"soccer": "exact_goals"},               # outcomes: 0, 1, 2+
    95:  {"soccer": "anytime_goalscorer"},
    96:  {"soccer": "first_goalscorer"},
    97:  {"soccer": "last_goalscorer"},
    98:  {"soccer": "btts"},
    99:  {"soccer": "odd_even_goals"},
    ...
    149: {"soccer": "anytime_goalscorer",
         "basketball": "match_winner"},
    150: {"soccer": "first_goalscorer",
    ...
    155: {"soccer": "first_half_1x2",
         "basketball": "point_spread"},
    156: {"soccer": "first_half_double_chance",
         "basketball": "asian_handicap"},
    157: {"soccer": "first_half_over_under",
         "basketball": "total_points"},
    158: {"soccer": "first_half_btts"},
    159: {"soccer": "first_half_correct_score"},
    160: {"soccer": "second_half_1x2",
         "basketball": "quarter_winner"},
    161: {"soccer": "second_half_over_under",
         "basketball": "over_under"},
    ...
    # ── Common high-number IDs seen in OD data ────────────────────────────────
    400: {"soccer": "over_under_goals",
          "basketball": "total_points",
          "tennis": "total_games"},
    401: {"soccer": "asian_handicap",
          "basketball": "point_spread",
          "tennis": "games_handicap"},
    402: {"soccer": "correct_score",
          "tennis": "set_betting"},
    500: {"soccer": "over_under_goals"},
    501: {"soccer": "asian_handicap"},
    502: {"soccer": "european_handicap"},
    503: {"soccer": "draw_no_bet"},
    504: {"soccer": "btts"},
    505: {"soccer": "double_chance"},
    506: {"soccer": "result_and_btts"},
    507: {"soccer": "result_and_over_under"},
    508: {"soccer": "exact_goals"},
    509: {"soccer": "odd_even_goals"},
    510: {"soccer": "correct_score"},
    511: {"soccer": "half_time_full_time"},
    512: {"soccer": "winning_margin"},
    513: {"soccer": "anytime_goalscorer"},
    514: {"soccer": "first_goalscorer"},
    515: {"soccer": "multigoals"},
    544: {"soccer": "result_and_over_under"},
    600: {"tennis": "match_winner",
          "soccer": "match_winner"},
    601: {"tennis": "set_betting",
          "soccer": "correct_score"},
    602: {"tennis": "total_games",
          "soccer": "over_under_goals"},
    603: {"tennis": "games_handicap",
          "soccer": "asian_handicap"},
    700: {"ice-hockey": "1x2",
          "soccer": "1x2"},
    701: {"ice-hockey": "total_goals",
          "soccer": "over_under_goals"},
    702: {"ice-hockey": "asian_handicap",
          "soccer": "asian_handicap"},
    703: {"ice-hockey": "moneyline"},
    800: {"soccer": "over_under_goals"},
    801: {"soccer": "asian_handicap"},
    820: {"soccer": "half_time_full_time"},
    881: {"soccer": "correct_score"},
    900: {"soccer": "anytime_goalscorer"},
    901: {"soccer": "first_goalscorer"},
    902: {"soccer": "last_goalscorer"},
    1000: {"soccer": "over_under_goals"},
    1001: {"soccer": "asian_handicap"},
    1100: {"soccer": "over_under_goals"},
    1200: {"soccer": "correct_score"},
}
