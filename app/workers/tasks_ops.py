...
#     # ── Live (HTTP fallback snapshots — WS is primary for SP) ────────────────
...
# # =============================================================================
# # WS publish (fire-and-forget Celery task)
# # =============================================================================

# @celery.task(
#     name="tasks.ops.publish_ws_event",
...
# # =============================================================================
# # EV / Arbitrage (per match, from UnifiedMatch.markets_json)
# # =============================================================================
...
# @celery.task(
#     name="tasks.ops.update_match_results",
...
# @celery.task(
#     name="tasks.ops.cache_finished_games",
#     soft_time_limit=120, time_limit=150,
# )
...
# @celery.task(
#     name="tasks.ops.expire_subscriptions",
...
def setup_periodic_tasks(sender, **kwargs):
    ...
    logger.info("[beat] All periodic tasks registered — SP/BT/OD/B2B/SBO")
